...
EXEFILE=~/stella_extra_knob/stella
#
OUTFILE=$SLURM_JOBID"_"$SLURM_JOB_NAME"_stella.out"
ERRFILE=$SLURM_JOBID"_"$SLURM_JOB_NAME"_stella.err"

mpirun -errfile-pattern $ERRFILE -outfile-pattern $OUTFILE -envall -genv -n $NUMPROC $EXEFILE input_centered_dgdz_and_dgdvpa_num_apar_fac.in
